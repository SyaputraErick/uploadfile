...
<style>
body {
  background-image: url("gambr2.jpg");
...
<center><h1 style="font-size:300%;">Daftar Mahasiswa</h1></center>
    ...
    <form action="" method="POST">
        <center><input type="text" name="keyword" size="40" autofocus placeholder="Cari data yang diinginkan.." autocomplete="off">
        <button type="submit" name="cari"> Search</button><center>
    </form>
    <br>
